@component('app')
    <div class="flex flex-wrap h-screen items-center justify-center">
        <div class="text-center">
            <div class="bg-white mx-auto rounded-full" style="width: 128px; height: 128px; background-color: #fb503b">
                <svg viewBox="0 0 700 700" fill="white"><path d="M556.8,344.2c-2.9-3.2-42.3-52.6-49.3-61c-7-8.4-10.3-6.9-14.6-6.2s-54.2,9-60,10c-5.8,1-9.4,3.3-5.9,8.3
            ...
            c2.4,3.3,35.4,45.1,36.7,46.7C538.8,339.4,536.7,340.4,533.8,341z"/></svg>
            </div>
